...
This repository contains two different kinds of material, licensed differently:

- **Site code** (Jekyll templates, Sass, JavaScript, configuration, etc.) is
  licensed under the [Apache License, Version 2.0][license], as detected by
  GitHub.
- **Content** (music, cover art, and other creative works published on
  [bitbear.music]) is licensed under [Creative Commons
  Attribution-NonCommercial 4.0 International (CC BY-NC 4.0)][cc-by-nc], as
  described in [`LICENSE-CONTENT`][license-content] and on the site's
  [License & Credits][license-page] page.
